  ...
  <div class="container">
    <div class="row">
        ...
        foreach ($comment_infos as $comment_info) {
          ...
          echo '<p style="margin-left:5px">'.$temp_comment_title.' <div style="text-align:right;margin-right:5px;display:inline;">Rating: '.$temp_comment_rating.'/5 </div></p>';
          echo '<p style="margin-left:5px">'.$temp_comment_person.':'.$temp_comment_text.'</p>';
          echo "</div><br>";
          }
        ?>
      </div>
